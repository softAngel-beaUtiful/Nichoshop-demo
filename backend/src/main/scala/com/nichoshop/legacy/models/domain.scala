...
case class AddressesRow(id: Int, userId: Int, creditCardId: Option[Int] = None, contactName: String, address1: String, address2: Option[String] = None, city: String, state: String, zip: String, country: String, phone: String)
