...
trait Tables {
  ...
  implicit def GetResultAddressesRow(implicit e0: GR[Int], e1: GR[Option[Int]], e2: GR[String], e3: GR[Option[String]]): GR[AddressesRow] = GR {
    prs => import prs._
      AddressesRow.tupled((<<[Int], <<[Int], <<?[Int], <<[String], <<[String], <<?[String], <<[String], <<[String], <<[String], <<[String], <<[String]))
  }
  ...
  class Addresses(_tableTag: Tag) extends Table[AddressesRow](_tableTag, "addresses") {
    def * = (id, userId, creditCardId, contactName, address1, address2, city, state, zip, country, phone) <>(AddressesRow.tupled, AddressesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (id.?, userId.?, creditCardId, contactName.?, address1.?, address2, city.?, state.?, zip.?, country.?, phone.?).shaped.<>({ r => import r._; _1.map(_ => AddressesRow.tupled((_1.get, _2.get, _3, _4.get, _5.get, _6, _7.get, _8.get, _9.get, _10.get, _11.get)))}, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val phone: Column[String] = column[String]("phone", O.Length(16, varying = true))
